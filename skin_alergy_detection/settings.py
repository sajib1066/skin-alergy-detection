"""
Django settings for skin_alergy_detection project.
...
from skin_alergy_detection.logging import LOGGING
...
ROOT_URLCONF = 'skin_alergy_detection.urls'
...
WSGI_APPLICATION = 'skin_alergy_detection.wsgi.application'
