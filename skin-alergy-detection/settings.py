"""
Django settings for skin-alergy-detection project.
...
from skin-alergy-detection.logging import LOGGING
...
ROOT_URLCONF = 'skin-alergy-detection.urls'
...
WSGI_APPLICATION = 'skin-alergy-detection.wsgi.application'
